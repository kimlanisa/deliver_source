                        ...
                        <div class="col-lg-9 col-xl-8">
                            ...
                            <div class="row">
                                <div class="col-xl-3 mb-4">
                                    <input type="text" class="js-flatpickr form-control" value="{{$startDate}}" id="start_date" name="start_date" placeholder="dari..">
                                </div> 
                                <div class="col-xl-3 mb-4">
                                    <input type="text" class="js-flatpickr form-control" value="{{$endDate}}" id="end_date" name="end_date" placeholder="sampai..">
                                </div>
                                <div class="col-xl-3 mb-4">
                                    <button type="submit" class="btn btn-alt-primary  btn-md">Filter Data</button>
                                    <a href="{{ route('export', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="btn btn-alt-success  btn-md">Excel</a>
                                </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 mb-4">
                                    <button type="submit" class="btn btn-alt-primary  btn-md">Filter Data</button>
                                    <a href="{{ route('exportByBulan') }}" class="btn btn-alt-success  btn-md">Excel</a>
                                </div>
