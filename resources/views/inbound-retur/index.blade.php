    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <a href="{{ route('inbound-retur.create') }}" class="btn btn-sm btn-alt-secondary"><i
                        class="fa fa-plus text-info me-1"></i>Inbound Retur Baru</a>
            </div>
        ...
        <div class="block block-rounded mt-4">
            <div class="block-header block-header-default d-flex justify-content-between pb-0">
                <ul class="nav nav-tabs tabs-process" style="cursor: pointer">
                    <li class="nav-item">
                        <div data-type="need_process" onclick="handleFilterStatus('need_process')" class="nav-link">Perlu
                            Diproses</div>
                    </li>
                    <li class="nav-item">
...
@section('js_after')
    ...
    <script>
        ...
        const table = $("#dataTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `{{ route('inbound-retur.getData') }}`,
                method: "POST",
                data: function(d) {
                    d.filter = filter;
                    return d;
        ...
        function handleFilterStatus(type) {
            let column_3 = table.column(3);
            let column_4 = table.column(4);
            if(type === 'done_process' || type === 'all') {
        ...
        handleFilterStatus('need_process');
        ...
        $('#submitHandle').on('submit', function(e) {
            e.preventDefault();
            let url = `{{ route('inbound-retur.destroy', ':id') }}`;
