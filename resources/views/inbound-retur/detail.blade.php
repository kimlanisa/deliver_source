            ...
            <div class="block-content block-content-full">
                <div class="row g-4">
                    ...
                    <div class="col-4">
                        ...
                        <input  class="form-control" value="{{ $data->sku }}" readonly/>
                    </div>
                    <div class="col-4">
                        <label class="form-label">Jumlah</label>
                        <input  class="form-control" value="{{ $data->jumlah }}" readonly/>
                    </div>
                    <div class="col-6">
                        <label class="form-label">Alasan Returan</label>
                        <textarea
                            class="form-control"  readonly>{{ $data->alasan_retur ?? '' }}</textarea>
                    </div>
                </div>
            </div>
        </div>
